...
class RpcBlockTracker extends EventEmitter {
  ...
  async _pollForNextBlock () {
    ...
    this.polling = setTimeout(this._performSync, this._pollingInterval)
  }
  ...
  _fetchLatestBlock () {
    return this._query.getBlockByNumberAsync('latest', true)
  }

  _fetchBlockByNumber (hexNumber) {
    const cleanHex = hexUtils.formatHex(hexNumber)
    return this._query.getBlockByNumberAsync(cleanHex, true)
  }
